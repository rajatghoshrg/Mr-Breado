    ...
    <section className="bg-[#FFF8F5] overflow-hidden py-24 px-4 sm:px-6">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-28 reveal">
          ...
          <Button
            size="lg"
            className="mt-10 px-8 py-4 text-lg shadow-lg"
          >
            Order Food Online
          </Button>
        ...
        <div className="relative">
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-16">
            ...
            {steps.map((step) => (
              ...
              <div
                key={step.id}
                style={{ transitionDelay: `${parseInt(step.id) * 0.1}s` }}
                className={`
                  group text-center flex flex-col h-full
                  ${step.id === "1" ? "reveal-left" : ""}
                  ${step.id === "2" ? "reveal" : ""}
                  ${step.id === "3" ? "reveal-right" : ""}
                `}
              >
